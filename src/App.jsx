...
function Shell({children}) { return <AppLayout>{children}</AppLayout>; }
...
export default function App() {
  return <Routes>
    ...
    <Route path="/admin/interns" element={<Shell><AdminInterns/></Shell>}/>
    <Route path="/admin/tasks" element={<Shell><AdminTasks/></Shell>}/>
    <Route path="/admin/performance" element={<Shell><AdminPerformance/></Shell>}/>
